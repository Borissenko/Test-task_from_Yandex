...
class App extends Component {
  ...
  search(pr, event){
    let searching = pr.filter(d => d.number == event.target.value)
    this.setState({fl: searching})
  }
    ...
    return (
      <div>
          <div className="container">
              ...
              <input onChange={this.search.bind(this, this.props.flightsAll)}
                     onBlur={this.select.bind(this, this.props.flightsAll)} type="text"/>
              ...
              <div className="red">
                  {this.state.fl == '' ? `No one was found. Please put number of flight more carefully.` : ''}
              </div>
